...
if (html_source && html_source.substr(0, 1) === '<') {
	formated_code = style_html(html_source, indent_size, indent_char, 80);
}
formated_code.length?WScript.Echo(formated_code):WScript.Echo('Are you sure your input is html source file?');
